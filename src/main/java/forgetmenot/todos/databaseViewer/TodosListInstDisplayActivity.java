...
public class TodosListInstDisplayActivity extends ListActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.todo_dbviewer_listheadinst);
    ...
    //label integers for to parameter of cursoradapter
        int[] to = new int[] {
                ...
                R.id.listheadinst_startday,
                R.id.listheadinst_stat
        };

        getLoaderManager().initLoader(0, null, this);
        adapter = new SimpleCursorAdapter(this, R.layout.dbview_listheadinst_row, null,
                ListHeaderInstTable.PROJECTION,to,0);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent i = new Intent(this, TodosListItemInstDisplayActivity.class);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        CursorLoader cursorLoader = new CursorLoader(this,
                MyTodoContentProvider.LISTHEADERINST_URI, ListHeaderInstTable.PROJECTION, null, null, null);
        return cursorLoader;
    }
